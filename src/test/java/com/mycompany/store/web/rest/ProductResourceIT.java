...
import com.mycompany.store.domain.enumeration.Rating;
/**
...
public class ProductResourceIT {
    ...
    private static final Rating DEFAULT_RECOMMENDED = Rating.One;
    private static final Rating UPDATED_RECOMMENDED = Rating.Two;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getRecommended()).isEqualTo(DEFAULT_RECOMMENDED);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getRecommended()).isEqualTo(UPDATED_RECOMMENDED);
    }
